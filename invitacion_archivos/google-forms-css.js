  ...
  jQuery.get('https://amoinvitar.com/js/google-forms-css/google-forms-css-cors.php?url=' + formURL, function(data) {
    ...
    items.forEach(function(item, index) {
      ...
      if (title || description) {
        ...
        var labelEl = jQuery('<p class="mt-4 mb-1"></p>');
        ...
        // title
        if (title) {
          var titleEl = jQuery('<div class="font-weight-bolder mt-2 mb-0"></div>');
          titleEl.text(title);
          if (required) {
        ...
        // description
        if (description) {
          var descriptionEl = jQuery('<p class="text-black-50 text-small-sm mb-2"></p>');
